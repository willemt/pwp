...
)
{
    ...
    bitstream_write_byte(&ptr, 6);     /* request */
    ...
    CuAssertTrue(tc, PWP_MSGTYPE_PIECE == bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 0 == fe(bitstream_read_uint32(&ptr))); /* piece one */
    CuAssertTrue(tc, 0 == fe(bitstream_read_uint32(&ptr))); /* block offset */
    CuAssertTrue(tc, 0xde == bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 0xad == bitstream_read_byte(&ptr));
}
#endif
...
)
{
    ...
    CuAssertTrue(tc, PWP_MSGTYPE_INTERESTED == bitstream_read_byte(&ptr));
}
...
)
{
    ...
    CuAssertTrue(tc, PWP_MSGTYPE_HAVE == bitstream_read_byte(&ptr));
...
)
{
    ...
    /*  message type */
    CuAssertTrue(tc, PWP_MSGTYPE_BITFIELD == bitstream_read_byte(&ptr));
    /* 11111111 11111111 11110000  */
    /*  please note the mock get_piece is always returning a piece */
    CuAssertTrue(tc, 0XFF == (unsigned char)bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 0XFF == (unsigned char)bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 0XF0 == (unsigned char)bitstream_read_byte(&ptr));
}
...
)
{
    ...
    CuAssertTrue(tc, 6 == bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 1 == fe(bitstream_read_uint32(&ptr)));
...
)
{
    ...
    CuAssertTrue(tc, 13 == fe(bitstream_read_uint32(&ptr)));
    /*  msgtype */
    CuAssertTrue(tc, 7 == bitstream_read_byte(&ptr));
    /* piece idx  */
    CuAssertTrue(tc, 0 == fe(bitstream_read_uint32(&ptr)));
    /*  block offset */
    CuAssertTrue(tc, 0 == fe(bitstream_read_uint32(&ptr)));
    /*  block payload */
    CuAssertTrue(tc, 0XDE == (unsigned char)bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 0XAD == (unsigned char)bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 0XBE == (unsigned char)bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 0XEF == (unsigned char)bitstream_read_byte(&ptr));
}
...
)
{
    ...
    /* read sent msg */
    CuAssertTrue(tc, 13 == fe(bitstream_read_uint32(&ptr)));
    CuAssertTrue(tc, 8 == bitstream_read_byte(&ptr));
    CuAssertTrue(tc, 1 == fe(bitstream_read_uint32(&ptr)));
    CuAssertTrue(tc, 0 == fe(bitstream_read_uint32(&ptr)));
    CuAssertTrue(tc, 20 == fe(bitstream_read_uint32(&ptr)));
}
...
)
{
    ...
    bitstream_write_byte(&ptr, 4);        /*  HAVE */
...
)
{
    ...
    void *pc, *mh;
    test_sender_t sender;
    char s_msg[1000], *s_ptr = s_msg;
    char r_msg[1000], *r_ptr = r_msg;
    chunkybar_t* sc;

    __sender_set(&sender,r_msg,s_msg);
    bitstream_write_uint32(&r_ptr, fe(5));       /*  length */
    bitstream_write_byte(&r_ptr, 4);        /*  HAVE */
    ...
    CuAssertTrue(tc, 2 == bitstream_read_byte(&s_ptr));
}
...
)
{
    ...
    bitstream_write_byte(&ptr, 0);        /* choke = 0 */
    /* receive */
    pwp_msghandler_dispatch_from_buffer(mh, msg, 4 + 1);
    /*  queue is now empty */
...
)
{
    ...
    bitstream_write_byte(&ptr, 6);        /*  message type */
...
)
{
    ...
    __sender_set(&sender, msg, NULL);
    bitstream_write_uint32(&ptr, fe(1));       /* length = 1 */
    bitstream_write_byte(&ptr, 2);        /* interested = 2 */
...
)
{
    ...
    bitstream_write_byte(&ptr, 5);        /*  bitpiece */
    bitstream_write_byte(&ptr, 0xFF);     /*  11111111 */
    bitstream_write_byte(&ptr, 0xFF);     /*  11111111 */
    bitstream_write_byte(&ptr, 0xF0);     /*  11110000 */
...
)
{
    ...
    bitstream_write_byte(&ptr, 5);
    bitstream_write_byte(&ptr, 0xff);
    bitstream_write_byte(&ptr, 0xff);
    bitstream_write_byte(&ptr, 0xf0);
...
)
{
    ...
    bitstream_write_byte(&ptr, 5);
    bitstream_write_byte(&ptr, 0xF0);     // 11110000
    bitstream_write_byte(&ptr, 0x00);     // 00000000
    bitstream_write_byte(&ptr, 0x08);     // 00001000
...
)
{
    ...
    /*  piece */
    bitstream_write_uint32(&ptr, fe(12));      /*  payload length */
    bitstream_write_byte(&ptr, 6);        /*  message type: request */
...
)
{
    ...
    bitstream_write_byte(&ptr, 7);        /*  piece type */
    bitstream_write_uint32(&ptr, fe(1));       /*  piece one */
    bitstream_write_uint32(&ptr, fe(0));       /*  byte offset is 0 */
    bitstream_write_byte(&ptr, 0xDE);
    bitstream_write_byte(&ptr, 0xAD);
...
)
{
    ...
    CuAssertTrue(tc, 0xDE == (unsigned char)sender.read_last_block_data[0]);
    CuAssertTrue(tc, 0xAD == (unsigned char)sender.read_last_block_data[1]);
}
...
)
{
    ...
    bitstream_write_byte(&ptr, 7);    /* piece msg = 7 */
    bitstream_write_uint32(&ptr, fe(0));   /* piece idx */
    bitstream_write_uint32(&ptr, fe(0));   /* block offset */
    bitstream_write_byte(&ptr, 0);   /* data */
...
)
{
    ...
    bitstream_write_byte(&r_ptr, PWP_MSGTYPE_CANCEL);
